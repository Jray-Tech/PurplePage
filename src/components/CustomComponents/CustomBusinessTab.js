      ...
      <ScrollView
        ...
        <View style={styles.headerContainer}>
          ...
          <Text style={styles.bio}>
            Lorem ipsum dolor sit amet consectetur. Ligula gravida bibendum et a
            mi orci. Et adipiscing eget lorem aliquet maecenas. Dui sit est
            scelerisque erat odio accumsan congue praesent. Felis porttitor
            eget.
          </Text>
        </View>
        <CustomBorder />
        <View style={styles.headerContainer}>
          ...
          <View style={styles.contactDetails}>
            ...
            <Text style={styles.bio}>
              ...
              doeiusmod tempor incididunt ut
            </Text>
          </View>
        </View>
        <CustomBorder />
    ...
    return (
      <SafeAreaView>
        <ScrollView
          ...
          <TouchableOpacity
            onPress={() => navigation.navigate('BusinessProductScreen')}>
            <View
              style={{
                width: '100%',
                height: '100%',
      ...
      <SafeAreaView>
        <ScrollView
          ...
          <View style={styles.headerContainer}>
            ...
            <View
              style={{paddingLeft: 70, paddingBottom: 10, paddingRight: 20}}>
              <Text
                style={{
                ...
                ipsum enimenim.Lorem Lorem ipsumdolo...
              </Text>
              <View
                style={{
                  flexDirection: 'row',
                ...
                <View style={{flexDirection: 'row'}}>
                  <Pressable
                    onPress={() => navigation.navigate('BlogInsightScreen')}>
  ...
  const Reviews = ({navigation}) => {
    return (
      <ScrollView
        ...
        <View
          style={{flexDirection: 'row', alignSelf: 'center', paddingBottom: 5}}>
          <Text
            style={{
              color: Colors.BOLD_BLACK,
              paddingHorizontal: 5,
        ...
        <Text
          ...
          {' '}
          Dui sit est scelerisque erat odio accumsan congue praesent. Felis
          porttitor eget.
        </Text>
        <Text
          style={{
      ...
      <Tab.Screen
        ...
        options={{
          tabBarLabel: ({focused, color}) => (
            <Text
              style={{
                color: focused ? Colors.PINK : Colors.DEFAULT_GREY,

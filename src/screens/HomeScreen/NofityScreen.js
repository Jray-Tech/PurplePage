...
if (isNotification) {
  return (
    ...
    <View style={styles.notificationsParagraph}>
        <Image source={NotifyIcon} style={[styles.logo]} resizeMode="contain" />
        <View style={styles.textContent}>
        <Text style={styles.text}><Text style={{color:Colors.PINK}}>Charlies Bagel Garden</Text> just replied your review</Text>

  ...
  const handleSheetChange = useCallback((index) => {
    ...
    return (
      <View style={styles.container}>
        ...
        <HomeNav text="Notification Settings" onPress={()=> navigation.goBack()}/>
        <View style={{ paddingHorizontal: 20, paddingTop: 50}}>
            <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
              <Text style={styles.links}>In-App Notifications</Text>
              <Feather 
                name={'chevron-right'}
                size={25}
            ...
            <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
              <Text style={styles.links}>Email Notifications</Text>
              <Feather 
                name={'chevron-right'}
                size={25}
                color={Colors.HEADER_BLACK}

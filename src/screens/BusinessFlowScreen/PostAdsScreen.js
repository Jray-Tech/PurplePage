...
export const PostAdsScreen = ({navigation}) => {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.body}>
          ...
          <Text style={styles.result}>Monthly</Text>
        </View>
        <View style={styles.body}>
          <Text style={styles.duration}>Plan:</Text>
          <Text style={styles.result}>Premium</Text>
        </View>
        <View style={{paddingHorizontal: 20}}>
          ...
          <Text style={{fontFamily: Font.AVENIR_MEDIUM, paddingTop: 8}}>
            Days chosen doesn’t need to be consecutive
          </Text>
        </View>
      </View>
      <View style={styles.buttonView}>
        <CustomButton
          ...
          onPress={() => navigation.navigate('PaymentBankTransferScreen')}
          type="PRIMARY"
        />
      </View>
    </View>
